...
**Sophie Qiu = Huilian Sophie Qiu（邱惠莲）**——CMU 2022 博士，现于西北大学与 Brian Uzzi 合作（JAMA 2024、IC2S2 2025）。理论锚点：**Dourish & Gómez Cruz 2018**——对，就是[随想 002](002-writing-like-dourish.zh.md)里被解剖文体的那个 Dourish；圈子真小。网里还有：Birhane 2022；Espeland & Sauder 2007（反应性）；Segel & Heer 2010 与 Hullman & Diakopoulos 2011（叙事可视化）。
...
两份原始文档（中文原样、不翻译）已随本笔记一并发布在 [`docs/`](docs/storytelling-survey.zh.md)——完整调研与提案 v2 全文，不止本篇摘要。
