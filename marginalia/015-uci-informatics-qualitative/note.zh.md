---
id: marginalia-015
title: 'UCI Informatics 系的质性 HCI 版图——调研:谁在做质性、STS 与健康信息'
date: 2026-09-05
published: 2026-09-05
kind: survey(院系调研)
sources:
  - 'UCI Informatics 系官网 People 页(informatics.ics.uci.edu/people,2026-09-05 抓取,63 人含 Core/Affiliated/Emeriti/Staff)'
  - '系官网自维护逐年会议论文页:2026 CHI Conference Papers / 2025 CHI Conference Papers / Conference Papers for CSCW 2025'
  - 'OpenAlex API(institution I204250578),逐作者拉取 2022–2026 作品;BD&S/STHV/ToCHI/PACMHCI 期刊场馆扫描'
  - '实验室与中心主页:EVOKE Lab(evoke.ics.uci.edu)、ARC(accessibility.ics.uci.edu)、CREATE(create.ics.uci.edu)、Connected Learning Lab(connectedlearning.uci.edu)、PIE Lab、Future Health;STAR 组经 Wayback Machine'
  - '教授个人主页:dourish.com、melissamazmanian.com、gillianhayes.com、ics.uci.edu/~yunanc、mimiito.com、ahnjune.com 等'
initial-prompt: '调查 UC Irvine Informatics 系里主要关注非软件工程方向的学者(HCI、信息、健康信息、日常生活),核心是做质性研究、偏 STS 或人类学取向的老师:他们关注什么方向、最近做哪些 topic、用什么方法和理论。'
agent: ZCode CLI
