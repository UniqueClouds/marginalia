---
id: marginalia-005
title: "Four academic voices, measured: the language styles of Big Data & Society / HCI / Sociology / Software Engineering classics (314 papers, 3.3M words)"
date: 2026-08-15
published: 2026-08-15
kind: analysis
sources:
  - "Local Zotero library, '各学科 Classic Papers' (Classic Papers by Discipline) — four sub-collections (BDS LRIBXNEX / HCI YFGQMV5V / Sociology PVXID4II / SE LQVVZNXL) → 314 PDF full texts, 1975–2026"
  - "ZCodeProject/discipline_style_analysis/ — full pipeline (00_resolve→05_cjk_clean) plus metrics/keyness/moves/ngrams/paras.json"
  - "Method & style baseline: marginalia-002 (Dourish, 21 texts)"
initial-prompt: "Following my analysis of Paul Dourish's language style, do the same for four other collections: analyze the language style of the papers in each of my discipline classic-paper collections — Big Data & Society, HCI, Sociology, Software Engineering."
agent: ZCode CLI
model: GLM (Zhipu)
issue: 11
---

# Four academic voices

> After measuring one author's voice ([002: Dourish](../002-writing-like-dourish/note.en.md)), measure a discipline: same Zotero library, same pipeline, four fields of classic papers. Can stylistic differences be *counted*? Yes — and each discipline turns out to run its own conceptual machine.
