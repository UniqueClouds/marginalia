---
id: marginalia-005
title: "四种学科的声音：Big Data & Society / HCI / Sociology / Software Engineering 经典论文的语言风格测量（314 篇 / 330 万词）"
date: 2026-08-15
published: 2026-08-15
kind: analysis（分析笔记）
sources:
  - "本地 Zotero 库「各学科 Classic Papers」四个子库（BDS LRIBXNEX / HCI YFGQMV5V / Sociology PVXID4II / SE LQVVZNXL）→ 314 篇 PDF 原文，1975–2026"
  - "ZCodeProject/discipline_style_analysis/ —— 全管线（00_resolve→05_cjk_clean）与 metrics/keyness/moves/ngrams/paras.json"
  - "方法论与文风对照基线：marginalia-002（Dourish 21 文本分析）"
initial-prompt: "仿照我对 paul dourish 的语言风格的分析，现在做其他的事情。在我各学科 classic paper 下面去分别分析 Big Data & society / human computer interaction / sociology / software engineering 的分别的论文的语言风格的探究。"
agent: ZCode CLI
model: GLM（智谱）
issue: 11
---
...
> 量完一个作者（[002：Dourish](../002-writing-like-dourish/note.zh.md)），接下来量学科：同一家 Zotero、同一条管线、四个领域的经典论文——文体差异能否被数出来？答案是：能，而且每个学科都有一台自己的"概念机器"。
