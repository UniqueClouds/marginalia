---
id: marginalia-007
title: "Nuance rising and falling in scientific writing: identification, measurement, and one local-corpus test (314 papers / 3.3M words)"
date: 2026-08-17
published: 2026-08-17
kind: analysis (analytical note)
sources:
  - "Reihan Salam quote inside *The Atlantic*'s Aug 2026 feature 'The Reading Crisis in the Postliterate Age' (quote supplied verbatim by user; preserved with full attribution in issue #14)"
  - "Local Zotero 'Classic Papers' sub-libraries across four disciplines (the [005] corpus) — 314 PDFs / 3.3M words; Dourish baseline 21 texts / 408k words (the [002] corpus)"
  - "ZCodeProject/discipline_style_analysis/nuance_scan.py — a new weak-hedge / scalar-modifier band counter written for this entry"
  - "External retrieval: Crossref API + Springer Nature + arXiv API + Semantic Scholar Graph API (with API key). Every citation carries a DOI."
initial-prompt: "Flesh out issue #14 into a musing: the rise and fall of nuance in scientific writing — how to identify and quantify it, up or down or sideways; and two related threads — social-media polarization incentives, and LLM insensitivity to weak degree modifiers (MASP)."
agent: ZCode CLI
model: GLM (Zhipu)
issue: 14
---
...
[004](../004-storytelling-quantified/note.en.md) quantified whether CHI / ACL is a "storytelling festival". [005](../005-discipline-style-voices/note.en.md) measured "disciplinary ritual" with the same instrument. This entry takes a third question to the same kind of measurement: is the weak-hedge vocabulary of science — "slightly", "to some extent", "partly", "a little" — being flattened? How do you identify and count it? What do you get when you do?
...
> — Source: [The Atlantic, Aug 2026, "The Reading Crisis in the Postliterate Age"](https://www.theatlantic.com/magazine/2026/08/reading-crisis-postliterate-age/687618/)
...
- *Writing Without Conviction? Hedging in Science Research Articles* (*Applied Linguistics* 17(4):433, 1996, DOI [`10.1093/applin/17.4.433`](https://doi.org/10.1093/applin/17.4.433)) — Semantic Scholar citations 776 / influential 101.
- *Hedging in Scientific Research Articles* (John Benjamins, *Pragmatics & Beyond New Series* 54, 1998, DOI [`10.1075/pbns.54`](https://doi.org/10.1075/pbns.54); review metadata at [`10.2307/417106`](https://doi.org/10.2307/417106)) — S2 citations 1193 / influential 185.
...
- **Yao, Wei & Wang 2023**, *Promoting research by reducing uncertainty in academic writing: a large-scale diachronic case study on hedging in Science research articles across 25 years* (*Scientometrics*, DOI [`10.1007/s11192-023-04759-6`](https://doi.org/10.1007/s11192-023-04759-6)). 25-year time series over *Science* research articles: the authors report hedge use tracks publication year, observed on a large corpus. S2 citations 30 / influential 1.
- **Poole, Gnann & Hahn-Powell 2019**, *Epistemic stance and the construction of knowledge in science writing: A diachronic corpus study* (*Journal of English for Academic Purposes* 42:100784, DOI [`10.1016/j.jeap.2019.100784`](https://doi.org/10.1016/j.jeap.2019.100784)). 328 open-access articles, segmented from 1972 forward, stance markers bucketed by time. S2 citations 60 / influential 4.
- **Petrocelli 2024**, *Between detachment and commitment: hedging and boosting from scientific articles to university press releases* (*Brno Studies in English*, DOI [`10.5817/bse2024-1-6`](https://doi.org/10.5817/bse2024-1-6)). 30 academic articles + matched university press releases — the study finds boosters are more frequent in press releases than in the underlying papers, while hedges are partly retained to "convey credibility by acknowledging scientific uncertainties." This lands directly on the science-writing → publicisation seam.
...
The reference list includes Hersh & Caramazza 1976 (*Journal of Experimental Psychology: General* 105(3):254–276, DOI [`10.1037/0096-3445.105.3.254`](https://doi.org/10.1037/0096-3445.105.3.254)) — the classical fuzzy-set treatment of degree modifiers and vagueness in natural language — and Kennedy 2007 *Vagueness and grammar: the semantics of relative and absolute gradable adjectives* (*Linguistics & Philosophy* 30(1):1–45, DOI [`10.1007/s10988-006-9008-0`](https://doi.org/10.1007/s10988-006-9008-0)). That places MASP inside formal-semantics lineage.
...
| **epistemic_hedge** | may / might / could / suggest(+s|ed|ing) / appear(+s|ed|ing) / seem(+s|ed|ing) / likely / perhaps / possibly / arguably / plausibly / approximately / roughly | Hyland 1996/1998 hedge end |
...
The full scatter (one row per paper) is in [`data/paper_level_rates.csv`](data/paper_level_rates.csv); discipline × decade aggregates in [`data/discipline_decade_rates.csv`](data/discipline_decade_rates.csv).
...
- "rather" counted as B2 in BDS / SOC / Dourish is mostly the residue of "rather than" (phrase-level, not degree-level); that is flagged in the [data/README.md](https://github.com/UniqueClouds/marginalia/blob/main/marginalia/007-nuance-rises-and-falls/data/README.md) caveat. B2 should be read discounted; B1 is largely clean (slightly / somewhat / a little …). Dourish's B2 overshoot was diagnosed back in [002].
...
| upstream | [002 Dourish style](../002-writing-like-dourish/note.en.md) · [004 storytelling quantified](../004-storytelling-quantified/note.en.md) · [005 four discipline voices](../005-discipline-style-voices/note.en.md) |
