...
kind: analysis（分析笔记）
sources:
  - "Reihan Salam 于 *The Atlantic* 2026 年 8 月号 'The Reading Crisis in the Postliterate Age' 的引语（用户提供原句；issue #14 脚注已全部保留）"
  - "本地 Zotero「各学科 Classic Papers」四子库（[005] 语料）—— 314 篇 PDF / 330 万词；Dourish 基线 21 篇 / 40.8 万词（[002] 语料）"
  - "ZCodeProject/discipline_style_analysis/nuance_scan.py —— 本篇新写的弱 hedge / scalar modifier 分档计数器"
  - "外部学术检索：Crossref API + Springer Nature + arXiv API + Semantic Scholar Graph API（带 API key）—— 所有引用均带 DOI"
initial-prompt: "把 issue #14 那条脚注补成一篇随想：科学论文里 nuance 的兴衰、怎么识别/计量、是变多还是变少；两条相关线索——社交媒体的极化激励、以及 LLM 对弱程度词的不敏感（MASP）。"
agent: ZCode CLI
model: GLM（智谱）
issue: 14
---
...
[004](../004-storytelling-quantified/note.zh.md) 把"CHI/ACL 是不是故事会"量了一遍，[005](../005-discipline-style-voices/note.zh.md) 量了"学科仪式"。这一篇想把第三件事拿来测：科学论文里那种"稍微 / 有点 / 在某种程度上 / 略略"的弱 hedge 表达，是不是在被压平？怎么识别、怎么数、数到的是什么。
...
| 上游 | [002 Dourish 风格](../002-writing-like-dourish/note.zh.md) · [004 故事会量化](../004-storytelling-quantified/note.zh.md) · [005 四学科声音](../005-discipline-style-voices/note.zh.md) |
