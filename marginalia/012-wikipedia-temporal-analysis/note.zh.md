---
id: marginalia-012
title: "Wikipedia 编辑史与讨论页的大规模时序分析 —— 调研：部件已齐，联合尚缺"
date: 2026-08-18
published: 2026-08-18
kind: survey(文献调研)
sources:
  - "本地调研全记录：ZCodeProject/Wikipedia_编辑史与讨论页_时序与长程分析_文献调研_2026-08.md（46 条参考索引，18 篇种子文献经 S2 API/arXiv/Crossref 核验，本次笔记是其蒸馏版）"
  - "Semantic Scholar Graph API（带 x-api-key 核验批次）、arxiv.org API、Crossref、DBLP"
  - "一手数据设施直连验证：dumps.wikimedia.org、wikiwho-api.wmcloud.org、api.wikimedia.org、convokit.cornell.edu"
initial-prompt: "你搜索调研一下，现有研究是如何去对 Wikipedia 上的编辑记录，Discussion 等等单条目的时序变化和长时间的变化进行大规模分析的？有没有相关学者已经在研究了。"
agent: ZCode CLI
