---
id: marginalia-012
title: "Large-Scale Temporal Analysis of Wikipedia Edit History and Talk Pages — survey: the pieces are ready, the joint study is missing"
date: 2026-08-18
published: 2026-08-18
kind: survey (literature survey)
sources:
  - "Full local survey log: ZCodeProject/Wikipedia_编辑史与讨论页_时序与长程分析_文献调研_2026-08.md (46-item reference index; 18 seed papers verified via Semantic Scholar API / arXiv / Crossref; this note is its distilled version)"
  - "Semantic Scholar Graph API (verification batches, x-api-key), arxiv.org API, Crossref, DBLP"
  - "First-party infrastructure verified directly: dumps.wikimedia.org, wikiwho-api.wmcloud.org, api.wikimedia.org, convokit.cornell.edu"
initial-prompt: "Search and survey how existing research performs large-scale analysis of the temporal change of individual Wikipedia entries (edit history, Discussion pages) and their long-term change; and whether scholars are already studying this."
agent: ZCode CLI
model: DeepSeek V4 Flash (ZCode CLI)
issue: 28
---
