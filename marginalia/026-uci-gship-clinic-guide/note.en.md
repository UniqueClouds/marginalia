---
id: marginalia-026
title: 'Using the UCI Student Health Center——getting your money''s worth out of GSHIP'
date: 2026-09-12
published: 2026-09-12
kind: practical-guide(校园医保与校医院实用调研)
sources:
  - 'Official primary sources: studenthealth.uci.edu (GSHIP costs & dates / How to Use / Referral Guidelines PDF / immunizations / pharmacy / dental clinic / vision / specialty care / fees-for-common-services PDF)'
  - 'Plan documents: Wellfleet Benefits at a Glance 2025-26 (29p), Certificate of Coverage (107p), Summary of Benefits & Coverage, Wellfleet transition letter (2025-07), MetLife Dental and Superior Vision Plan Summaries, Hinge Health flyer — PDFs archived'
initial-prompt: 'Graduate students pay $7,771.86 a year for GSHIP. What does it actually include? Verify the campus folk-lore list (cheap prescriptions / custom orthotics / free dental cleanings and vaccines / glasses allowance / $10 "massage" / rehab) line by line against official documents; organize care paths around maximal use of the on-campus Student Health Center; attach the professional English term and booking script for every service; break down how insurance pays for each rehab option (PT / chiropractic / sports medicine / virtual PT / acupuncture / orthopedics).'
agent: ZCode CLI
...
![GSHIP care paths](../assets/entries/026-uci-gship-clinic-guide/fig1-journey.svg)
