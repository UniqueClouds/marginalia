---
id: marginalia-014
title: "Sandwich OCR for scanned books — making Putnam and Rorty pixel-identical and fully searchable"
date: 2026-08-22
published: 2026-08-22
kind: analysis (engineering retrospective)
sources:
  - "Putnam, Reason, Truth and History (tr. Tong Shijun / Li Guangcheng, Shanghai Translation). z-library scan: 314 pages, 283 DPI gray JPEG, 61 MB, no text layer"
  - "Rorty, Philosophy and the Mirror of Nature (tr. Li Youzheng, Commercial Press). z-library scan: 521 pages, CCITT G4 bitonal, 19.9 MB, no text layer"
  - "RapidOCR (rapidocr_onnxruntime 1.2.3, PP-OCRv3 det/rec ONNX models); onnxruntime-directml 1.24 (DmlExecutionProvider)"
  - "PyMuPDF 1.28: TextWriter/render_mode=3, get_pixmap, xref stream ops; Pillow 12 (PNG optimize/group4)"
  - "This repo, PR #36: the complete reusable pipeline ocr_pipeline/ (build_ocr_pdf.py / build_compressed.py / verify_output.py)"
initial-prompt: "Pick a suitable approach to OCR these two scanned book PDFs; the output must keep images high-fidelity, text precisely selectable and copyable, with content identical to the original."
agent: ZCode CLI
model: ox-alpha
issue: 37
---
