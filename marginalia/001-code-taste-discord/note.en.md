---
id: marginalia-001
title: "Do coding agents have taste? What 29,787 Discord messages say about beautiful vs. ugly code"
date: 2026-08-15
published: 2026-08-15
kind: analysis
sources:
  - "ZCodeProject/discord_workflow/raw/ — 4 Discord communities (Matt's AI Heroes, Latent Space, EleutherAI, Cursor), 51 channel JSON exports, 29,787 messages with body text, 2024-11 → 2026-08"
  - "ZCodeProject/code_beauty_simplification/ — extract_hits.py → filter_pass2.py → extract_pass3.py; corpus_out/ (25 hit files); hit_stats.json (550 hits)"
  - "ZCodeProject/code_beauty_simplification/fedorova2025.txt — full text of Fedorova et al. 2025"
...
Door #0, already taken: → [NOTUGLY-S, musing 003](../003-notugly-s/note.en.md), which formalizes sanction / imitation / not-ugly into a machine-learning objective.
