---
id: marginalia-001
title: "编码代理有品味吗？29,787 条 Discord 消息里的美/丑代码话语"
date: 2026-08-15
published: 2026-08-15
kind: analysis（分析笔记）
sources:
  - "ZCodeProject/discord_workflow/raw/ —— 四个 Discord 社区（Matt's AI Heroes、Latent Space、EleutherAI、Cursor），51 个频道 JSON 导出，29,787 条含正文消息，2024-11 至 2026-08"
  - "ZCodeProject/code_beauty_simplification/ —— extract_hits.py → filter_pass2.py → extract_pass3.py 管线；corpus_out/（25 个命中文件）；hit_stats.json（550 命中）"
  - "ZCodeProject/code_beauty_simplification/fedorova2025.txt —— Fedorova 等 2025 论文全文"
initial-prompt: "编码代理能否判别优雅/丑陋的代码、并学会因仓库而异的标准？代理是否在让代码库系统性变复杂；能否让它做减法？"
agent: ZCode CLI
model: GLM（智谱）
issue: 1
---
...
第 0 扇门已经走了：→ [NOTUGLY-S，随想 003](../003-notugly-s/note.zh.md)，把制裁/模仿/不丑形式化为机器学习目标。
