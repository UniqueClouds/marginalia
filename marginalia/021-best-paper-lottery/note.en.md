---
id:              marginalia-021
title:           "Re-run the review and half the program changes — Best Paper randomness and the floor of 'not-ugly'"
date:            2026-09-06
published:       2026-09-06
kind:            essay（随想）
sources:
  - "NeurIPS 2021 Consistency Experiment (official blog 2021-12-08; paper arXiv:2306.03262); NeurIPS 2014 experiment and its revisit arXiv:2109.09774"
  - "Bayesian reanalysis of the 2014 experiment arXiv:1507.06411 (RFC model: base-quality rate ≈56%)"
  - "Shah et al., 'Design and Analysis of the NIPS 2016 Review Process' (tml.cs.uni-tuebingen.de)"
  - "ACL Conference Awards Policy (aclweb.org/adminwiki, 'fascinating, controversial, surprising…'); ACL 2017 PC account (acl2017.wordpress.com)"
  - "Score-sharing bias study (TAMU×Cornell, 1,261 posts from Zhihu+Reddit, yanfajia.com/news/6470.html); Sumner et al. BMJ 2014 / PLOS ONE 2016; Vinkers et al. BMJ 2015 (+880% positive words); Communications Psychology 2025 (130k abstracts, promotional language → +9–14% citations)"
  - "ToT materials: SIGIR Forum 2017 special issue; Paxson/McKeown/Rexford, 'Selecting the 2008 SIGCOMM Test-of-Time Award' doi:10.1145/1517480.1517488; Jeff Huang best-paper dataset (jeffhuang.com/best_paper_awards)"
  - "Internal basis: NOTUGLY-S (marginalia 003; code_beauty_simplification/) — source of the 'learn not-ugly, not beauty' criterion migration"
...
- Internal source: NOTUGLY-S proposal ([003 · NOTUGLY-S](../003-notugly-s/note.en.md))
- Kant, *Critique of Judgment*; Bourdieu, *Distinction* (1984); Lamont, *How Professors Think* (2009)
- Related entry: [023 · Journal mediatization](../023-journal-mediatization/note.en.md) (the demand side of taste redirection)
