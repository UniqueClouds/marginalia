---
id:              marginalia-008
title:           "「How to Scale Your Model」摘记：把 LLM 训练从玄学拆成 roofline 公算法（JAX-ML scaling book）"
date:            2026-08-17
published:       2026-08-17
kind:            note（读书笔记）
sources:
  - "How to Scale Your Model —— https://jax-ml.github.io/scaling-book/ （开源在线书，首版 2025-02-04）"
  - "作者：Jacob Austin · Sholto Douglas · Roy Frostig · Anselm Levskaya · Charlie Chen · Sharad Vikram · Federico Lebron · Peter Choy · Vinay Ramasesh · Albert Webson · Reiner Pope（Google DeepMind / MatX）"
initial-prompt: "新的随想笔记：对 google 的这本书做一些简要摘要，主要是 note 这本书（https://jax-ml.github.io/scaling-book/）"
agent:           ZCode CLI
model:           GLM（智谱）
issue:           15
---
...
- 与 [002 · 写作如 Dourish](../002-writing-like-dourish/note.zh.md) 和 [005 · 四学科声音](../005-discipline-style-voices/note.zh.md) 同席别有趣味——那些笔记量的是"修辞信号"，这本量的是"算力信号"。但合读会撞出一句反讽：SE 论文里被压成一句 fut. work 的"扩展成本"，在这本书里占满整整一章。
